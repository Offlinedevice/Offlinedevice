...
So during next login you can use the long base58 password (more difficult) or you can use one of your HW-keys by holding it close to the reader and type in your PIN (if any).  
