#!/usr/bin/env python3
#
#  Update script for GUIApp.py v0.4.2
#  
...
answer = messagebox.askquestion('Important!', 'Before installing version 0.4.2 you first have to install version 0.4.1 or later.\n Have you done that?')
