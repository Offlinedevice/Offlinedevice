					...
					for lines in csvfile:
						if lines:
							...
							if Counting == 0:	
								...
								Button2 = ctk.CTkButton(left_Frame, text="", image = walletimagebutton, anchor='center', text_color="white", fg_color="brown", border_width=2, border_color="brown", width=220, height=100, font=my_font, command=partial(self.showBitcoinwallet, lines[0]))
								Button2.pack(padx=10, pady=8, side= TOP, anchor="w")
								Llabel2 = ctk.CTkLabel(left_Frame, text=lines[0], text_color="white", font=my_font, fg_color="black")
								Llabel2.pack(padx=1, pady=0, side= TOP, anchor="center")
							Counting += 1
