...
class Menu(ctk.CTkFrame):	
	...
	def create_getStartedmeny(self):
		...
		my_font = ctk.CTkFont(family="Arial", size=16, weight="bold", slant="italic", underline=True, overstrike=False)
		Label7 = ctk.CTkLabel(self, text="(4). A Yubikey 5C NFC (hardware device) with subkeys for encrypting emails on computers and smartphones (optional).", text_color="white", fg_color="black", font=my_font)
	...
	def create_getStartedmeny2(self):	
		...
		checkbox = ctk.CTkCheckBox(my_Frame, text="I got a Yubikey.", variable=check_var, onvalue="on", offvalue="off", text_color="white", fg_color="black", font=my_font)
	...
	def getStartedfinnished(self):
		...
		Label6 = ctk.CTkLabel(my_Frame, text="(4). A Yubikey 5C NFC (hardware device) with subkeys for encrypting emails on a smartphones etc (optional).", text_color="white", fg_color="black", font=my_font)
	...
	def create_FIDOmeny(self):
		...
		if path_to_USB_secure == 'Secure USB folder is available':
			...
			infoLabel = ctk.CTkLabel(right_Frame, text="1. Use a hardware key with FIDO2 support (ex. Yubikey 5C or similar).", text_color="white", font=my_font, fg_color="black")
					...
					for lines in csvfile:
						try:
							if lines[0] == cardname:
								...
								programButton.place(relx=0.49, rely=0.68, anchor="center")
								...
								programButton2.place(relx=0.49, rely=0.74, anchor="center")
								...
								delButton.place(relx=0.49, rely=0.84, anchor="center")
								...
								backButton.place(relx=0.49, rely=0.9, anchor="center")
						except:
	...
	def create_getSettimetextbox(self):
		...
		time_picker = AnalogPicker(self, type=constants.HOURS24)
		time_picker.setHours(datetime.now().hour)
		time_picker.setMinutes(datetime.now().minute)
		time_picker.place(relx=0.72, rely=0.55, anchor="e")
	...
	def sign_key_on_keychain(self):
		...
		Label2 = ctk.CTkLabel(my_Frame, text="Select (1). What the private key to sign with. (2). Select the public key that you intend to sign.", text_color="white", fg_color="black", font=my_font)
		Label2.place(relx=0.5, rely=0.30, anchor="center")
		
		Label3 = ctk.CTkLabel(my_Frame, text="(Remember! If the master key is only with cerification capability then you need to select the signing subkey)", text_color="white", fg_color="black", font=my_font)
		Label3.place(relx=0.5, rely=0.35, anchor="center")
