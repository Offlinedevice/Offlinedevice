...
Create your own multisig signing keys and wallets. Share transactions (request signature and receive signed back), wallets and signing keys using PGP-encrypted and signed messaging.
